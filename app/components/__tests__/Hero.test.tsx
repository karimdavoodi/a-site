...
describe("Hero", () => {
  it("renders the masjid name", () => {
    render(<Hero />);
    expect(screen.getByRole("heading", { name: "Al-Salaam Islamic Centre" })).toBeInTheDocument();
  });

  it("renders the masjid slogan", () => {
    render(<Hero />);
    expect(screen.getByText("Serving the Community with Faith and Compassion!")).toBeInTheDocument();
  });
